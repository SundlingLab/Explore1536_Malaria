...
```{r Figure1-wo-annotation, fig.height=9, message=FALSE, warning=FALSE, dev= c("png","pdf"), out.width='100%'}
...
pdf(paste0(result.dir,"Figure_2_S4.pdf"), width = 6.9, height = 7)#,paper = "a4",colormodel = my_pdf_colormodel)
